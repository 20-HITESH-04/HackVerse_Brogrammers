        ...
        <Card className="w-full max-w-md bg-white shadow-lg rounded-xl overflow-hidden border border-gray-200">
          ...
          <CardContent>
            ...
            <p className="text-center text-sm text-gray-600 mt-4">
              Are you an admin? <Link href="/admin/signin" className="text-blue-600 hover:underline">Admin Login</Link>
            </p>
            <p className="text-center text-sm text-gray-600 mt-2 pb-4">
              New admin? <Link href="/admin/signup" className="text-blue-600 hover:underline">Admin Signup</Link>
            </p>
          </CardContent>
        </Card>
      </div>
